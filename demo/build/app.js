...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		...
		exports["AtmosphericDiagnostics"] = factory();
	else
		root["AtmosphericDiagnostics"] = factory();
})(this, function() {
...
function weatherRequest(location) {
    return new Promise(function (resolve, reject) {
        var apiKey = 'fbdccfd084f3904f4953985dd358c569';
        var city = 'London';
        var endPoint = "http://api.openweathermap.org/data/2.5/forecast?q=" + location + ",uk&mode=json&appid=" + apiKey;
        fetch(endPoint, {
            method: 'GET',
            headers: {
...
var Weather_1 = __webpack_require__(4);
var nvd3_1 = __webpack_require__(2);
 ...
 *
 */
var AtmosphericDiagnostics = (function () {
    function AtmosphericDiagnostics(selector, configuration) {
        if (configuration === void 0) { configuration = new Configuration_1.Configuration(); }
        this.selector = selector;
        this.configuration = configuration;
        this.destroyBoundWithThis = this.detach.bind(this);
        this.hostElement = document.querySelector(selector);
    }
    AtmosphericDiagnostics.prototype.addListeners = function () {
        var _this = this;
        document.querySelector('.get-data').addEventListener('click', function (event) {
            Weather_1.weatherRequest(document.querySelector('input[name="location"]').value).then(function (result) {
                _this.renderHumidity([{
                        key: "Humidity",
                        values: result["list"]
                    }]);
                _this.renderPressure([{
                        key: "Pressure",
                        values: result["list"]
                    }]);
                console.log(result);
    ...
    AtmosphericDiagnostics.prototype.attach = function () {
    ...
    AtmosphericDiagnostics.prototype.detach = function () {
    };
    AtmosphericDiagnostics.prototype.renderHumidity = function (data) {
        nvd3_1.addGraph(function () {
            var chart = nvd3_1.models.lineChart()
                .x(function (d) {
                return d.dt * 1000;
            ...
            d3_1.select('.weather-humidity svg')
                .datum(data)
                .call(chart);
            chart.xAxis.rotateLabels(30)
                .showMaxMin(true)
                .tickFormat(function (d) {
                var f = d3_1.time.format('%d-%m-%y')(new Date(d));
                return f.toUpperCase();
            }).ticks(7);
            chart.update();
            nvd3_1.utils.windowResize(chart.update);
            return chart;
        });
    };
    AtmosphericDiagnostics.prototype.renderPressure = function (data) {
        nvd3_1.addGraph(function () {
            var chart = nvd3_1.models.lineChart()
                .x(function (d) {
                return d.dt * 1000;
            ...
            d3_1.select('.weather-pressure svg')
                .datum(data)
                .call(chart);
            chart.xAxis.rotateLabels(30)
                .showMaxMin(true)
    ...
    return AtmosphericDiagnostics;
}());
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = AtmosphericDiagnostics;


/***/ })
/******/ ]);
});
//# sourceMappingURL=atmospheric-diagnostics.js.map
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../demo/node_modules/css-loader/index.js!./atmospheric-diagnostics.css", function() {
			var newContent = require("!!./../demo/node_modules/css-loader/index.js!./atmospheric-diagnostics.css");
...
var atmospheric_diagnostics_1 = __webpack_require__(0);
__webpack_require__(1);
function init() {
    var selector = ".container";
    var component = new atmospheric_diagnostics_1.default(selector);
    component.attach();
}
init();
